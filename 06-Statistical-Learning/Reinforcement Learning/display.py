...
def display_position(image, position=None, positions=None, marker='o', marker_size=100, marker_color='b', interval=200, height=3):
    fig, ax = plt.subplots()
...
def display_board(image, board=None, boards=None, marker1='x', marker2='o', marker_size=100,
                  color1='b', color2='r', interval=200, height=3):
    fig, ax = plt.subplots()
    fig.set_figheight(height)
    ax.axis('off')
    ax.imshow(image)
